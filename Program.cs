...
namespace MyTelegram.Bot
{
    class Program
    {
        private const string urlCoinString = "https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&ids=space-" +
            "hamster&order=market_cap_desc&per_page=100&page=1&sparkline=false&price_change_percentage=1h%2C24h%2C7d";
        static public ITelegramBotClient botClient;

        static void Main()
        {
            botClient = new TelegramBotClient("Your token Bot");
